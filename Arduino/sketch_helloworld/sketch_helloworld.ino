...
void time_setup(){
  char* time = __TIME__
  char* date = __DATE__
  char y[4] = {time[0], time[1], time[2], time[3]}
  char m[3] = {time[5], time[6], time[7]}
  char d[2] = {time[9], time[10]}
  char h[2] = {time[0], time[1]}
  char min[2] = {time[3], time[4]}
  char s[2] = {time[6], time[7]}
  char* 87
}
